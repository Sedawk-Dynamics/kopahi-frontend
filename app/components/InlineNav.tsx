...
/*
 * Sticky/fixed nav with dropdowns. Used inline on pages that need a custom
 * scroll-state header (home/about/b2b). For most pages prefer <PageShell />.
 */
export default function InlineNav({
  ...
  return (
    <nav className={`${variant === "fixed" ? "fixed" : "sticky"} top-0 left-0 right-0 z-50`}>
      {withTopBar && (
        <div className="hidden md:block bg-gradient-to-r from-green-900 via-green-800 to-green-900 text-white text-[13px] tracking-wide">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 h-9 lg:h-10 flex items-center justify-between">
            <p className="font-medium">Open Doors To A World Of Indigenous Food</p>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-[88px] sm:h-24 lg:h-[112px] flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <Link href="/signup" className="px-6 py-3 rounded-xl bg-gradient-to-r from-green-700 to-green-600 text-white text-sm font-bold shadow-lg hover:shadow-2xl hover:-translate-y-0.5 transition-all">Sign Up</Link>
              <Link href="/cart" aria-label="View cart" className="relative w-11 h-11 rounded-full border border-gray-200 bg-white hover:bg-green-50 transition flex items-center justify-center shadow-sm">
            ...
            <div className="lg:hidden flex items-center gap-2">
              <Link href="/cart" aria-label="View cart" className="relative w-10 h-10 rounded-xl border border-gray-200 bg-white flex items-center justify-center shadow-sm">
                <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l1 5h13l2-5h-15zm3 8h12l-1 6H7l-1-6z" />
                </svg>
              </Link>
              <button
